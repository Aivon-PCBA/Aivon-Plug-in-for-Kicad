...
baseUrl = 'https://www.aivon.com/'
uploadPath = '/product/KiCadUpFile/'
netlistFilename = 'Aivon_netlist.ipc'
bomFilename = 'Aivon_bom.csv'
positionsFilename = 'Aivon_positions.csv'
plotPlan = [
